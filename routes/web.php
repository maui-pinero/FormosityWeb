...
Route::group(['prefix' => 'account'],function() {
    ...
    Route::group(['middleware' => 'auth'],function() {
        ...
        Route::post('/order-detail/{orderId}/cancel',[AuthController::class,'cancelOrder'])->name('account.order.cancel');
...
Route::group(['prefix' => 'admin'],function() {
    ...
    Route::group(['middleware' => 'admin.guest'],function() {
        ...
        Route::get('/',[AdminLoginController::class,'index'])->name('admin.dashboard');
