                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input value="{{ $coupon->max_uses_user }}" type="text" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Max Uses Per User">
                            <p></p>		
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="discount_amount">Expires At</label>
