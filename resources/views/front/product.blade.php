            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <div class="product-price d-flex align-items-center">
                        ...
                        <h2 class="price text-danger ml-2"><del>${{ $product->compare_price }}</del></h2>
                        @endif
                    </div>
            ...
            <div id="related-products" class="carousel">
                ...
                <div class="card product-card">
                    <div class="product-image position-relative">
                        ...
                        <a onclick="addToWishlist({{ $relProduct->id }})" class="wishlist" href="javascript:void(0);"><i class="far fa-heart"></i></a>                            
                    ...
                    <div class="card-body text-center mt-3">
                        <a class="h6 link" href="{{ route('front.product', $relProduct->slug) }}" style="font-size: 1.25rem;">{{ $relProduct->title }}</a>
                        <div class="price mt-2">
                            <span class="h5"><strong>${{ $relProduct->price }}</strong></span>
                            @if ($relProduct->compare_price > 0)
                            <span class="h6 text-underline text-danger"><del>${{ $relProduct->compare_price }}</del></span>
                            @endif
                        </div>
                    </div>                        
                </div>
