	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{ url('/') }}" class="text-decoration-none mobile-logo">
				<img src="{{ asset('front-assets/images/logo_mobile.png') }}" alt="Logo">
				<span></span>
			</a>
    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
      			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						<button class="btn btn-cream dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
							{{ $category->name }}
						</button>
			...
			<div class="right-nav py-0">
				<a href="{{ route("front.cart") }}" class="ml-3 d-flex pt-2 ">
					<i class="fas fa-shopping-cart text-cream"></i>					
				</a>
			</div> 		
      	</nav>
  	</div>
...
<footer class="bg-pink mt-5">
	<div class="container pb-5 pt-3">
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Get In Touch</h3>
					<p>Formosity, an online flower shop. <br>
					Dagupan City, Pangasinan, PH <br>
					formosityshopph@gmail.com <br>
					0900 000 0000</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright 2024, Formosity. All Rights Reserved.</p>
					</div>
				</div>
			</div>
		</div>
