                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body checkout-form">
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        <select name="location" id="location" class="form-control">
                                            ...
                                            @foreach ($locations as $location)
                                                <option {{ (!empty($customerAddress) && $customerAddress->location_id == $location->id) ? 'selected' : '' }} value="{{ $location->id }}">{{ $location->name }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                        <p></p>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <input type="text" name="province" id="province" class="form-control" placeholder="Province" value="{{ (!empty($customerAddress)) ? $customerAddress->province : '' }}">
                                        <p></p>
                                    </div>            
                                </div>
    ...
    <script>
        ...
        $("#apply-discount").click(function(){
            $.ajax({
                ...
                type: 'post',
                data: {code: $("#discount_code").val(), location_id: $("#location").val()},
                dataType: 'json',
                success: function(response) {
                    if (response.status == true) {
                        $("#shippingAmount").html('$'+response.shippingCharge);
