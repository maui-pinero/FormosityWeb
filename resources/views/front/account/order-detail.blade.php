                ...
                <div class="card card-lg mb-5 mt-3">
                    <div class="card-body">
                        ...
                        @if ($order->status != 'cancelled' && $order->status != 'shipped' && $order->status != 'delivered')
                            <form method="post" action="{{ route('account.order.cancel', $order->id) }}" class="d-flex justify-content-end">
                                @csrf
                                @method('POST')
                                <button type="submit" class="btn btn-danger" onclick="return confirmCancellation();" id="cancelButton">Cancel Order</button>
                            </form>
                        @endif
