                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                    ...
                                    <select name="location_id" id="location_id" class="form-control">
                                        ...
                                        @if ($locations->isNotEmpty())
                                            @foreach ($locations as $location)
                                                <option {{ (!empty($address) && $address->location_id == $location->id) ? 'selected' : '' }} value="{{ $location->id }}">{{ $location->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <p></p>
                                ...
                                <div class="col-md-6 mb-3">                                    
                                    ...
                                    <input value="{{ (!empty($address)) ? $address->apartment : '' }}" type="text" name="apartment" id="apartment" placeholder="Apartment (optional)" class="form-control">
                                    <p></p>
                                </div>
                                <div class="col-md-6 mb-3">                                    
                                ...
                                <div class="col-md-6 mb-3">                                    
                                    ...
                                    <input value="{{ (!empty($address)) ? $address->province : '' }}" type="text" name="province" id="province" placeholder="Province" class="form-control">
                                    <p></p>
                                </div>
                                <div class="col-md-6 mb-3">                                    
                                    <label for="zip">Zip Code</label>
                                    <input value="{{ (!empty($address)) ? $address->zip : '' }}" type="text" name="zip" id="zip" placeholder="Zip Code" class="form-control">
                                    <p></p>
                                </div>
                                <div class="d-flex">
                                    <button class="btn btn-dark">Update</button>
